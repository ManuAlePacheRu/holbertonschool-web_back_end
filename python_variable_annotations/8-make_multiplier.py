...
Функция `make_multiplier` принимает один аргумент `multiplier` типа `float`, который
представляет собой множитель. Она возвращает функцию, которая принимает один аргумент `x` типа
